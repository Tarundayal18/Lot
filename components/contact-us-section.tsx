...
//     { icon: Mail, title: "Email", value: "hello@littleotherthings.com" },
...
export default function ContactUsSection() {
  ...
  // ✅ Web3Forms Submit Function (same as first code)
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <h2 className="font-oswald text-5xl md:text-7xl lg:text-8xl font-bold text-purple-900 mb-4">
            Get In Touch
          </h2>
          <div className="w-20 h-1 bg-gradient-to-r from-purple-600 to-yellow-400 mx-auto mb-6" />
          <p className="text-lg md:text-xl text-purple-700 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            <h3 className="font-oswald text-3xl md:text-4xl font-bold text-purple-900 mb-8">
              Contact Information
            </h3>
            ...
            <div className="space-y-6 mb-12">
              {contactInfo.map((info, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="relative overflow-hidden rounded-2xl p-6 bg-white border-2 border-purple-300 hover:border-yellow-400 hover:shadow-xl transition-all duration-500"
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-oswald font-bold text-purple-900 mb-1 text-lg">
                          {info.title}
                        </h4>
                        <p className="text-purple-700">{info.value}</p>
                      </div>
                    </div>
                  </div>
                );
            ...
            {/* Social Links */}
            <div className="relative rounded-2xl p-8 border-2 border-purple-300 transition-all duration-300">
              <p className="text-purple-900 font-oswald font-bold mb-4 text-lg">
                Follow Us
              </p>
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <a
                    ...
                    href={social.link}
                    target="_blank"
                    className="px-4 py-2 rounded-lg bg-purple-100 hover:bg-gradient-to-r hover:from-purple-600 hover:to-yellow-500 text-purple-600 hover:text-white font-semibold transition-all duration-300"
                  >
                    {social.name}
                  </a>
                ))}
          ...
          >
            <form
              onSubmit={handleSubmit}
              className="relative rounded-3xl p-8 md:p-12 border-2 border-purple-300 bg-white transition-all duration-300"
            >
              <div className="space-y-6">
                {/* Name */}
                <div>
                  <label className="font-oswald font-bold text-purple-900 mb-2 block">
                    Full Name
                  </label>
                  <input
                    type="text"
                    ...
                    value={formData.name}
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl border-2 border-purple-300 bg-white focus:ring-2 focus:ring-yellow-400"
                    placeholder="Your name"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    value={formData.message}
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl border-2 border-purple-300 resize-none"
                ...
                <button
                  type="submit"
                  className="w-full py-3 rounded-xl font-bold text-lg bg-gradient-to-r from-purple-600 to-yellow-500 text-white shadow-lg hover:opacity-90 transition-all"
                >
                  Send Message
                </button>
              </div>
