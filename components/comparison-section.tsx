...
//       us: "Zero franchise fees",
//       other: "High upfront fees",
//     },
//     {
//       title: "Profit Margin",
//       us: "45% profit margin",
//       other: "Lower retail margins",
//     },
//     {
//       title: "Inventory",
//       us: "Curated fast-moving stock",
//       other: "Slow-moving inventory",
//     },
//     {
//       title: "Dead Stock Risk",
//       us: "No dead stock risk",
//       other: "High dead stock risk",
//     },
//     {
//       title: "Operational Support",
//       us: "Full operational support",
//       other: "Limited training support",
//     },
//     {
//       title: "Store Design",
//       us: "Free store design help",
//       other: "Design cost on owner",
//     },
//     {
//       title: "Marketing",
//       us: "Centralized marketing",
//       other: "Self-managed marketing",
//     },
//     {
//       title: "Systems",
//       us: "Mobile-based operations",
//       other: "Manual/complex systems",
//     },
//     {
//       title: "Product Range",
//       us: "Impulse-buy product range",
//       other: "Generic product mix",
//     },
//     {
//       title: "Store Appeal",
//       us: "Strong retail experience",
//       other: "Weak in-store appeal",
//     },
//   ]
...
//         style={{ backgroundImage: "radial-gradient(circle at 20% 50%, rgba(45, 90, 77, 0.15) 0%, transparent 50%)" }}
//       />
...
//         >
//           <h2 className="font-oswald text-5xl md:text-7xl font-bold text-foreground mb-6">How Are We Better?</h2>
...
//               <div className="bg-secondary rounded-2xl p-6 md:p-8 flex items-center justify-center border border-border hover:border-accent/50 transition-all duration-300 group">
//                 <h3 className="font-oswald font-bold text-foreground text-center text-base md:text-lg group-hover:text-accent transition-colors">
//                   {item.title}
//                 </h3>
//               </div>

//               <div className="relative rounded-2xl p-6 md:p-8 border-2 border-accent bg-accent/5 flex items-center justify-center group hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
//                 <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-10 bg-gradient-to-br from-accent to-accent-secondary transition-opacity" />
//                 <p className="font-semibold text-foreground text-center text-base md:text-lg relative z-10">
//                   {item.us}
//                 </p>
//                 <div className="absolute top-3 right-3 w-2 h-2 bg-accent rounded-full group-hover:w-3 group-hover:h-3 transition-all" />
//               </div>

//               <div className="rounded-2xl p-6 md:p-8 bg-muted/50 border border-border flex items-center justify-center group hover:bg-muted/70 transition-all">
//                 <p className="text-muted-foreground text-center text-base md:text-lg line-through opacity-75 group-hover:opacity-60">
//                   {item.other}
//                 </p>
//               </div>
//             </div>
...
//         >
//           <button className="bg-accent hover:bg-accent/90 text-accent-foreground px-8 md:px-12 py-3 md:py-4 rounded-full font-semibold text-base md:text-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:scale-105">
