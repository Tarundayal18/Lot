...
//           className="absolute inset-0 z-0"
//           style={{
//             background: "linear-gradient(135deg, #f8f6f3 0%, #f5f2ed 50%, #f2efea 100%)",
//             backgroundImage: `
//               linear-gradient(135deg, #f8f6f3 0%, #f5f2ed 50%, #f2efea 100%),
...
//             <div className="w-32 h-32 md:w-40 md:h-40 rounded-full bg-gradient-to-br from-purple-600 to-purple-800 p-3 shadow-lg">
...
//           <h1 className="font-oswald text-5xl md:text-6xl lg:text-8xl font-bold text-[#1a1a1a] leading-tight mb-4 tracking-tight">
//             Unlock High Returns
//             <span className="block text-purple-600">with Low Investment</span>
//             <span className="block text-[#1a1a1a] text-4xl md:text-5xl lg:text-6xl">
//               Your Path to Retail Success Starts Here
//             </span>
//           </h1>

//           <p className="text-lg md:text-xl text-[#6b6b6b] mb-6 font-light max-w-3xl mx-auto leading-relaxed">
//             Partner with Little Other Things and capitalize on the booming demand for curated, adorable lifestyle
//             products. Zero franchise fees, high margins, and complete support.
//           </p>
...
//             className="px-8 md:px-10 py-3 md:py-4 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-full font-oswald font-bold text-lg hover:from-purple-700 hover:to-purple-800 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
//           >
//             Know Your Investment
//           </button>
//         </div>
...
//       <section className="w-full py-16 md:py-24 px-4 md:px-8 bg-gradient-to-b from-[#f8f6f3] via-[#f5f2ed] to-[#f2efea]">
//         <div className="max-w-7xl mx-auto">
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
//             {cards.map((card, index) => (
//               <div
...
//                     <div className="mt-6 flex items-center gap-3 text-yellow-400 group-hover:translate-x-2 transition-transform duration-300">
//                       <span className="text-lg font-bold">Learn More</span>
//                       <span className="text-2xl">→</span>
//                     </div>
//                   </div>
...
//                 value={formData.name}
//                 onChange={handleChange}
//                 className="w-full px-4 py-3 rounded-lg border border-purple-200 focus:border-purple-600 focus:outline-none transition-colors bg-purple-50"
//                 required
//               />
//               <input
//                 type="email"
...
//                   type="button"
//                   onClick={() => setIsModalOpen(false)}
//                   className="flex-1 px-4 py-3 rounded-full border-2 border-purple-300 text-[#1a1a1a] font-oswald font-bold hover:border-purple-600 transition-colors"
//                 >
//                   Cancel
//                 </button>
//                 <button
//                   type="submit"
//                   className="flex-1 px-4 py-3 rounded-full bg-gradient-to-r from-purple-600 to-purple-700 text-white font-oswald font-bold hover:from-purple-700 hover:to-purple-800 transition-colors"
//                 >
//                   Submit
//                 </button>
//               </div>
